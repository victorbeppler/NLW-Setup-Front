    ...
    return (
        <Popover.Root>
            <Popover.Trigger className={clsx("w-10 h-10 bg-zinc-900 border-2 border-zinc-800 rounded-lg", {
                ...
                'bg-violet-900 border-violet-700': comlpetedPercentage >= 0 && comlpetedPercentage < 20,
                'bg-violet-800 border-violet-600': comlpetedPercentage >= 20 && comlpetedPercentage < 40,
                ...
                'bg-violet-500 border-violet-300': comlpetedPercentage >= 80,
            })}>
                <Popover.Portal>
                    <Popover.Content className='min-w-[320px] w-full p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                        <span className='font-semibold text-zinc-400'>segunda-feira</span>
                        <span className='mt-1 font-extrabold leading-tight text-3xl'>10/10/2021</span>
